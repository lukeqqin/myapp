<template>
    <view class="mxio-scrollx-warpper">
        ...
        <view class="mxio-scrollx-bar-box" v-if="barShow">
            <view class="mxio-scrollx-bar-item" :style="{transform: `translateX(${scrollViewLeft}px)`}">
...
const emits = defineEmits<{ (e: 'scrollItemEmitsClick', item: object, index: number, obj: object[]): void }>();
...
const scrollItemClick = (item: object, index: number, obj: object[]) => {
